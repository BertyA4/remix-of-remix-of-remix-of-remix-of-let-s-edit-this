        ...
        <nav className="flex items-center justify-between py-4">
          ...
          >
            <motion.span
              ...
              className={
                logoUrl
                  ? "h-10 w-10 rounded-xl overflow-hidden flex items-center justify-center bg-transparent"
                  : "h-10 w-10 rounded-xl bg-gradient-to-br from-[hsl(var(--accent))] via-[hsl(330_90%_55%)] to-[hsl(var(--gold))] flex items-center justify-center shadow-[0_0_24px_hsl(var(--accent)/0.4)] overflow-hidden p-1"
              }
            >
              {logoUrl ? (
